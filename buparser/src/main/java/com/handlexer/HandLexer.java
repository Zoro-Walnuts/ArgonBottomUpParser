...
public class HandLexer {
    ...
    public TokenList Analyze(File in) throws IOException {
        ...
        // printing tokenlist (chronological list of all tokens)
        System.out.println("Note: all values are sanitized (escape sequences are printed as is)");
        System.out.println("TokenList:");
        tokenList.printTokens();
        System.out.println();

        // printing tokenset (chronological set of all unique identifiers
        // and literals and their first occurence)
        System.out.println("Identifiers / Numerical Literals:");
        tokenSet.printTokens();
        System.out.println();

        // printing the output file into command line
        System.out.println("Output:");
        output += "\n\n" + numErrs + " ERRORS FOUND!\n" + errorsStr;
        System.out.println(output);

        // printing neat output file into command line
        ...
        try {
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter("LexAnalyzerOutput.txt"));
            writer.write(output);
            writer.close();
        } catch (IOException e) {
        ...
        try {
            // writing to output file
            BufferedWriter writer = new BufferedWriter(new FileWriter("LexAnalyzerNeatoutput.txt"));
